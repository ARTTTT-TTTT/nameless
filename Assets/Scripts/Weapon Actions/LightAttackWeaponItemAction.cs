...
namespace ART
{
    ...
    public class LightAttackWeaponItemAction : WeaponItemAction
    {
        ...
        [SerializeField] private string light_Attack_01 = "Main_Light_Attack_01";  // Main = main hand

        [SerializeField] private string light_Attack_02 = "Main_Light_Attack_02";

        [Header("Running Attacks")]
        [SerializeField] private string running_Attack_01 = "Running_Attack_01";

        [Header("Rolling Attacks")]
        [SerializeField] private string rolling_Attack_01 = "Rolling_Attack_01";

        [Header("Backstep Attacks")]
        [SerializeField] private string backstep_Attack_01 = "Backstep_Attack_01";

        // TWO HAND
        [Header("Light Attacks")]
        [SerializeField] private string th_light_Attack_01 = "TH_Light_Attack_01";  // th = two hand
        ...
        [Header("Rolling Attacks")]
        [SerializeField] private string th_rolling_Attack_01 = "TH_Rolling_Attack_01";
