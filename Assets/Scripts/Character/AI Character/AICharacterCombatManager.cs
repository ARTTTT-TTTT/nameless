...
namespace ART
{
    public class AICharacterCombatManager : CharacterCombatManager
    {
        ...
        [SerializeField] private float stanceregeneratedPersecond = 15;
        [SerializeField] private bool ignoreStanceBreak;

        [Header("Stance Timer")]
        [SerializeField] private float stanceRegenerationTimer = 0;

        private float stanceTickTimer = 0;
        [SerializeField] private float defaultTimeUntilStanceRegenerationbegins = 15;
