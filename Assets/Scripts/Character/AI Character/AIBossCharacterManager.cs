...
namespace ART
{
    public class AIBossCharacterManager : AICharacterManager
    {
        ...
        [SerializeField] private string phaseShiftAnimation = "Phase_Change_01";
        [SerializeField] private CombatStanceState phase02CombatStanceState;

        [Header("States")]
        [SerializeField] private BossSleepState sleepState;
