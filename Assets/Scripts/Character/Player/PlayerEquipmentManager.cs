...
namespace ART
{
    public class PlayerEquipmentManager : CharacterEquipmentManager
    {
        ...
        [SerializeField] private bool equipNewItems = false;
        ...
        public void LoadHeadEquipment(HeadEquipmentItem equipment)
        {
            ...
            Debug.Log(equipment.headEquipmentType);
        ...
        public void LoadLegEquipment(LegEquipmentItem equipment)
        {
            ...
            // 6. LOAD  EQUIPMENT MODELS
            Debug.Log("before pull model from object");
            Debug.Log(equipment.equipmentModels);
            foreach (var model in equipment.equipmentModels)
            {
                Debug.Log(model);
                model.LoadModel(player, player.playerNetworkManager.isMale.Value);
            }
            Debug.Log("after pull model from object");
        ...
        public void LoadRightWeapon()
        {
            if (player.playerInventoryManager.currentRightHandWeapon != null)
            {
                ...
                ToggleTwoHandingMode(player.playerInventoryManager.currentRightHandWeapon);
            }
        }
        ...
        */
        ...
        public void LoadLeftWeapon()
        {
            if (player.playerInventoryManager.currentLeftHandWeapon != null)
            {
                ...
                bool isLeftWeaponShield = player.playerInventoryManager.currentLeftHandWeapon.weaponModelType == WeaponModelType.Shield;
                bool isRightWeaponGreatsword = player.playerInventoryManager.currentRightHandWeapon != null &&
                                               player.playerInventoryManager.currentRightHandWeapon.weaponClass == WeaponClass.Greatsword;

                if (isLeftWeaponShield && isRightWeaponGreatsword)
                {
                    // Move the shield to the back slot
        ...
        public void SwitchRightWeapon()
        {
            ...
            StartCoroutine(SwitchWeaponWithDelay(true));
        }
        ...
        public void SwitchLeftWeapon()
        {
            ...
            StartCoroutine(SwitchWeaponWithDelay(false));
        }

        public void FinishSwitchRightWeapon()
        {
        ...
        public void FinishSwitchLeftWeapon()
        {
            WeaponItem selectedWeapon = null;
        ...
        private IEnumerator SwitchWeaponWithDelay(bool isRight)
        {
            ...
            if (isRight)
            {
                FinishSwitchRightWeapon();
            }
            else
            {
                FinishSwitchLeftWeapon();
            }
        }

        private void ToggleTwoHandingMode(WeaponItem selectedWeapon)
        {
            if (selectedWeapon.weaponClass == WeaponClass.Greatsword)
            {
