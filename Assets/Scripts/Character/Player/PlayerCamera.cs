...
namespace ART
{
    public class PlayerCamera : MonoBehaviour
    {
        ...
        [SerializeField] private float cameraSmoothSpeed = 0.1f; // BIGGER VALUES MAKES THE CAMERA TAKE LONGER TO REACH TO ITS POSITION, SLOWER AT CATCHING UP THE PLAYER

        [SerializeField] private float leftAndRightRotationSpeed = 700;
        [SerializeField] private float upAndDownRotationSpeed = 700;
        [SerializeField] private float minimumPivot = -80; // THE LOWEST POINT A PLAYER IS ABLE TO LOOK DOWN
        [SerializeField] private float maximumPivot = 80; // THE HIGHEST POINT A PLAYER IS ABLE TO LOOK DOWN
