...
namespace ART
{
    public class MeleeWeaponDamageCollider : DamageCollider
    {
        ...
        //    Collider characterCollider = characterCausingDamage?.GetComponent<Collider>();

        //    if (weaponCollider != null && characterCollider != null)
        //    {
        //        Physics.IgnoreCollision(weaponCollider, characterCollider);
        //        Debug.Log("Ignoring collision between weapon and character: " + characterCausingDamage.name);
        //    }
        //    else
        //    {
        //        Debug.LogError("Collider missing! Weapon: " + weaponCollider + " Character: " + characterCollider);
        //    }
        //}
        ...
        protected override void OnTriggerEnter(Collider other)
        {
            ...
            {
                damageTarget = other.transform.root.GetComponent<CharacterManager>();
            }
